...
namespace MInspectorExamples
{
    ...
    public class TestScript : MonoBehaviour
    {
        ...
        // add this variable to your script so mInspector won't forget after recompilation which foldouts are expanded and which tabs are selected
        public MInspectorData mInspectorData;
