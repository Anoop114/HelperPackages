    ...
    static class MInspectorResettableVariables
    {
        ...
        static object GetTargetWithDefaulValues(Type targetType)
        {
            ...
            void script_2023plus()
            {
                ...
                var tempGo = EditorUtility.CreateGameObjectWithHideFlags("Dummy object for fetching default variable values for mInspector's resettable variables feature", HideFlags.HideAndDontSave, targetType);
