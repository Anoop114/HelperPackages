...
{
    public static class MInspector
    {
        ...
        static void UpdateNavbars() // update
        {
            void updateNavbar(EditorWindow window)
            {
                ...
                var shouldHaveNavbar = MInspectorMenu.navigationBarEnabled && !window.GetMemberValue<bool>("isLocked");
            ...
            void createNavbar(EditorWindow window)
            {
                ...
                navbar.name = "mInspector-navbar";

                navbar.style.width = Length.Percent(100);
                navbar.style.height = 28;

                var navbarGui = new MInspectorNavbar(window);
                ...
                navbarSpacer.name = "mInspector-navbar-spacer";
            ...
            {
                var navbar = window.rootVisualElement.Q("mInspector-navbar");
                var navbarSpacer = window.rootVisualElement.Q("mInspector-navbar-spacer");
        ...
        static void PasteButton_OnGUI(EditorWindow window, Rect rect)
        {
            ...
            var isActive = MInspectorComponentClipboard.CanComponentsBePastedTo(editor.targets.Cast<GameObject>());
            var copiedDatas = MInspectorComponentClipboard.instance.copiedComponetDatas;
            ...
            void pasteButton_active()
            {
                ...
                foreach (var target in editor.targets)
                    foreach (var data in copiedDatas)
                        MInspectorComponentClipboard.PasteComponentAsNew(data, target as GameObject);

                if (!curEvent.holdingAlt)
                    MInspectorComponentClipboard.ClearCopiedDatas();
        ...
        static void UpdatePasteButtons() // update and selectionChanged
        {
            void updateButton(EditorWindow window)
            {
                ...
                var hasCopiedComponents = MInspectorComponentClipboard.instance.copiedComponetDatas.Any();
            ...
            void createButton(EditorWindow window)
            {
                ...
                buttonHolder.name = "mInspector-paste-component-button-holder";
        ...
        static void ComponentShortcuts() // globalEventHandler
        {
            ...
            void expandOrCollapseHovered()
            {
                ...
                if (!MInspectorMenu.toggleExpandedEnabled) return;
            ...
            void expandOrCollapseAll()
            {
                ...
                if (!curEvent.isKeyDown || curEvent.keyCode != KeyCode.E) return;
                if (!MInspectorMenu.collapseEverythingEnabled) return;
            ...
            void collapseEverythingElse()
            {
                ...
                if (!curEvent.isKeyDown || curEvent.keyCode != KeyCode.E) return;
                if (!MInspectorMenu.collapseEverythingElseEnabled) return;
                if (hoveredComponentHeader == null) return;
            ...
            void toggleActive()
            {
                ...
                if (Tools.viewTool == ViewTool.FPS) return;
                if (!MInspectorMenu.toggleActiveEnabled) return;
                if (hoveredComponentHeader == null) return;
            ...
            void delete()
            {
                ...
                if (!MInspectorMenu.deleteEnabled) return;
                if (hoveredComponentHeader == null) return;
                ...
                if (requiredByComponent == null && hoveredComponent is not Transform)
                    if (MInspectorMenu.componentAnimationsEnabled)
        ...
        public static MInspectorComponentHeader hoveredComponentHeader;
        ...
        class ExpandAnimation
        {
            public void Start()
            {
                ...
                void createMaskElement()
                {
                    ...
                    maskElement.name = "mInspector-mask-for-expand-animation";
        ...
        class DeleteAnimation
        {
            public void Start()
            {
                ...
                void createSpacerElement()
                {
                    ...
                    spacerElement.name = "mInspector-spacer-for-delete-animation";
        ...
        static void UpdateComponentHeaders(Editor editor) // finishedDefaultHeaderGUI
        {
            ...
            void createHeader(Component component)
            {
                ...
                componentHeaders_byComponent__byEditor[editor][component] = new MInspectorComponentHeader(component, editor);
        ...
        static Dictionary<Editor, Dictionary<Component, MInspectorComponentHeader>> componentHeaders_byComponent__byEditor = new();
        ...
        static void Init()
        {
            if (MInspectorMenu.pluginDisabled) return;
            ...
            void subscribe()
            {
                ...
                EditorApplication.quitting -= MInspectorState.Save;
                EditorApplication.quitting += MInspectorState.Save;

                EditorApplication.playModeStateChanged -= OnPlaymodeStateChanged;
                EditorApplication.playModeStateChanged += OnPlaymodeStateChanged;

                EditorApplication.playModeStateChanged -= MInspectorComponentClipboard.OnPlaymodeStateChanged;
                EditorApplication.playModeStateChanged += MInspectorComponentClipboard.OnPlaymodeStateChanged;
            ...
            void loadData()
            {
                data = AssetDatabase.LoadAssetAtPath<MInspectorData>(EditorPrefs.GetString("mInspector-lastKnownDataPath-" + GetProjectId()));


                if (data) return;

                data = AssetDatabase.FindAssets("t:MInspectorData").Select(guid => AssetDatabase.LoadAssetAtPath<MInspectorData>(guid.ToPath())).FirstOrDefault();


                if (!data) return;

                EditorPrefs.SetString("mInspector-lastKnownDataPath-" + GetProjectId(), data.GetPath());
            ...
            {
                if (!EditorPrefs.HasKey("mInspector-pluginWasReenabled")) return;

                OnPluginReenabled();

                EditorPrefs.DeleteKey("mInspector-pluginWasReenabled");
        ...
        public static MInspectorData data;
        ...
        public static MethodInfo mi_VHierarchy_GetIconName = t_VHierarchy?.GetMethod("GetIconName_forMInspector", maxBindingFlags);
