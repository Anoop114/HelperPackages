    ...
    public class MInspectorNavbar
    {
        ...
        public void OnGUI(Rect navbarRect)
        {
            ...
            void selectPrevButton()
            {
                ...
                var disabled = !MInspectorSelectionHistory.instance.prevStates.Any();
                ...
                MInspectorSelectionHistory.instance.MoveBack();
            ...
            void selectNextButton()
            {
                ...
                var disabled = !MInspectorSelectionHistory.instance.nextStates.Any();
                ...
                MInspectorSelectionHistory.instance.MoveForward();
            ...
            void bookmarks()
            {
                void createData()
                {
                    ...
                    data = ScriptableObject.CreateInstance<MInspectorData>();

                    AssetDatabase.CreateAsset(data, GetScriptPath("MInspector").GetParentPath().CombinePath("mInspector Data.asset"));
                ...
                void icon()
                {
                    ...
                    void drawTexture_material()
                    {
                        ...
                        if (!assetPreviewMaterial)
                            assetPreviewMaterial = new Material(Shader.Find("Hidden/MInspectorAssetPreview"));
        ...
        float GetItemCenterX(int i, bool includeGaps = true)
        {
        ...
        void BookmarksAnimations()
        {
            ...
            void gaps_()
            {
                ...
                for (int i = 0; i < gaps.Count; i++)
                    if (makeSpaceForDraggedItem && i == insertDraggedItemAtIndex)
                        gaps[i] = Lerp(gaps[i], draggedItem.width, lerpSpeed, editorDeltaTime);
                    else
            ...
            void droppedItem_()
            {
                ...
                var targX = GetItemCenterX(data.items.IndexOf(droppedItem), includeGaps: true);

                SmoothDamp(ref droppedItemX, targX, lerpSpeed, ref droppedItemXDerivative, editorDeltaTime);
        ...
        public MInspectorNavbar(EditorWindow window) => this.window = window;
