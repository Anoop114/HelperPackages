...
{
    public class MInspectorComponentWindow : EditorWindow
    {
        ...
        public static List<MInspectorComponentWindow> instances = new();
        ...
        {
            draggedInstance = ScriptableObject.CreateInstance<MInspectorComponentWindow>();
        ...
        public static MInspectorComponentWindow draggedInstance;
