...
{
    public class MHierarchyComponentWindow : EditorWindow
    {
        void OnGUI()
        {
            ...
            void header()
            {
                ...
                void icon()
                {
                    ...
                    GUI.Label(iconRect, MHierarchy.GetComponentIcon(component));
                ...
                void name()
                {
                    ...
                    var s = MHierarchy.GetComponentName(component);
        ...
        void OnDestroy()
        {
            ...
            EditorPrefs.SetFloat("mHierarchy-componentWindowWidth", position.width);
        ...
        {
            floatingInstance = ScriptableObject.CreateInstance<MHierarchyComponentWindow>();

            floatingInstance.ShowPopup();


            var savedWidth = EditorPrefs.GetFloat("mHierarchy-componentWindowWidth", minWidth);
        ...
        public static MHierarchyComponentWindow floatingInstance;
