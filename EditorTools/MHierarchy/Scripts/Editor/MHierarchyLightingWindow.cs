...
{
    public class MHierarchyLightingWindow : EditorWindow
    {
        void OnGUI()
        {
            void updateSize()
        ...
        {
            instance = ScriptableObject.CreateInstance<MHierarchyLightingWindow>();
        ...
        public static MHierarchyLightingWindow instance;
