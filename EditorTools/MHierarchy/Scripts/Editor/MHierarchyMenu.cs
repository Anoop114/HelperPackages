...
{
    class MHierarchyMenu
    {

        public static bool componentMinimapEnabled { get => EditorPrefs.GetBool("mHierarchy-componentMinimapEnabled", false); set => EditorPrefs.SetBool("mHierarchy-componentMinimapEnabled", value); }
        public static bool hierarchyLinesEnabled { get => EditorPrefs.GetBool("mHierarchy-hierarchyLinesEnabled", false); set => EditorPrefs.SetBool("mHierarchy-hierarchyLinesEnabled", value); }
        public static bool minimalModeEnabled { get => EditorPrefs.GetBool("mHierarchy-minimalModeEnabled", false); set => EditorPrefs.SetBool("mHierarchy-minimalModeEnabled", value); }
        public static bool zebraStripingEnabled { get => EditorPrefs.GetBool("mHierarchy-zebraStripingEnabled", false); set => EditorPrefs.SetBool("mHierarchy-zebraStripingEnabled", value); }
        public static bool activationToggleEnabled { get => EditorPrefs.GetBool("mHierarchy-acctivationToggleEnabled", false); set => EditorPrefs.SetBool("mHierarchy-acctivationToggleEnabled", value); }
        public static bool collapseAllButtonEnabled { get => EditorPrefs.GetBool("mHierarchy-collapseAllButtonEnabled", false); set => EditorPrefs.SetBool("mHierarchy-collapseAllButtonEnabled", value); }
        public static bool editLightingButtonEnabled { get => EditorPrefs.GetBool("mHierarchy-editLightingButtonEnabled", false); set => EditorPrefs.SetBool("mHierarchy-editLightingButtonEnabled", value); }

        public static bool toggleActiveEnabled { get => EditorPrefs.GetBool("mHierarchy-toggleActiveEnabled", true); set => EditorPrefs.SetBool("mHierarchy-toggleActiveEnabled", value); }
        public static bool focusEnabled { get => EditorPrefs.GetBool("mHierarchy-focusEnabled", true); set => EditorPrefs.SetBool("mHierarchy-focusEnabled", value); }
        public static bool deleteEnabled { get => EditorPrefs.GetBool("mHierarchy-deleteEnabled", true); set => EditorPrefs.SetBool("mHierarchy-deleteEnabled", value); }
        public static bool toggleExpandedEnabled { get => EditorPrefs.GetBool("mHierarchy-toggleExpandedEnabled", true); set => EditorPrefs.SetBool("mHierarchy-toggleExpandedEnabled", value); }
        public static bool collapseEverythingElseEnabled { get => EditorPrefs.GetBool("mHierarchy-collapseEverythingElseEnabled", true); set => EditorPrefs.SetBool("mHierarchy-collapseEverythingElseEnabled", value); }
        public static bool collapseEverythingEnabled { get => EditorPrefs.GetBool("mHierarchy-collapseEverythingEnabled", true); set => EditorPrefs.SetBool("mHierarchy-collapseEverythingEnabled", value); }

        public static bool pluginDisabled { get => EditorPrefs.GetBool("mHierarchy-pluginDisabled", false); set => EditorPrefs.SetBool("mHierarchy-pluginDisabled", value); }




        const string dir = "Tools/mHierarchy/";
        ...
        const string disablePlugin = dir + "Disable mHierarchy";
        ...
        [MenuItem(dir + "Clear cache", false, 1002)] 
        static void dassaadsdc() => MHierarchyCache.Clear();
        
        
        [MenuItem(dir + "Help", false, 10002)] static void daasadsddsas() { }
        [MenuItem(dir + "Help", true, 10002)] static bool dadsadsdasas123() => false;
        
        [MenuItem(dir + "Open Help", false, 10003)]
        static void dadasdsas() => Application.OpenURL("https://google.com");//todo: add help link 
